...
if ($q)
  $__quizzes = $q->fetch_all(MYSQLI_ASSOC);
...
<aside class="sidebar">
  <div class="brand">
    <div class="logo-heart" aria-hidden="true">
      <svg viewBox="0 0 24 24">
        <path
          d="M12 21s-5.052-3.33-8.097-6.375C1.52 12.242 1.29 8.93 3.514 6.706a5.25 5.25 0 0 1 7.424 0L12 7.768l1.062-1.062a5.25 5.25 0 0 1 7.424 0c2.224 2.224 1.994 5.536-.389 7.919C17.052 17.67 12 21 12 21z" />
      </svg>
    </div>
  ...
  <nav>
    ...
    <a href="admins.php" class="<?= ($active === 'admins' ? 'active' : '') ?>"><span class="ico">👑</span><span
